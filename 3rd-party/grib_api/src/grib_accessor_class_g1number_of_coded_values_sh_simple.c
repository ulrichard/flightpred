...
/* Members defined in g1number_of_coded_values_sh_simple */
...
} grib_accessor_g1number_of_coded_values_sh_simple;

extern grib_accessor_class* grib_accessor_class_long;

static grib_accessor_class _grib_accessor_class_g1number_of_coded_values_sh_simple = {
    &grib_accessor_class_long,                      /* super                     */
    "g1number_of_coded_values_sh_simple",                      /* name                      */
    sizeof(grib_accessor_g1number_of_coded_values_sh_simple),  /* size                      */
    0,                           /* inited */
