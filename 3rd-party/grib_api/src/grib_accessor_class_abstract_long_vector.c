...
/*
   ...
   MEMBERS = long* v
   MEMBERS = long pack_index
   MEMBERS = int number_of_elements
   END_CLASS_DEF
...
static grib_accessor_class _grib_accessor_class_abstract_long_vector = {
    &grib_accessor_class_gen,                      /* super                     */
    "abstract_long_vector",                      /* name                      */
    sizeof(grib_accessor_abstract_long_vector),  /* size                      */
    0,                           /* inited */
