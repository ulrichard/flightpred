...
/*
   ...
   IMPLEMENTS = init
   MEMBERS = const char* bitmapIndicator
   END_CLASS_DEF
 */
...
} grib_accessor_g2bitmap_present;

extern grib_accessor_class* grib_accessor_class_long;

static grib_accessor_class _grib_accessor_class_g2bitmap_present = {
    &grib_accessor_class_long,                      /* super                     */
    "g2bitmap_present",                      /* name                      */
    sizeof(grib_accessor_g2bitmap_present),  /* size                      */
    0,                           /* inited */
...
static int  unpack_long(grib_accessor* a, long* val, size_t *len)
{
  ...
  if((ret = grib_get_long_internal(a->parent->h, self->bitmapIndicator,&bitmapIndicator))
      != GRIB_SUCCESS)
    return ret;
