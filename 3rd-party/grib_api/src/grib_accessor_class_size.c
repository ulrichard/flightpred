...
typedef struct grib_accessor_size {
    grib_accessor          att;
/* Members defined in gen */
/* Members defined in long */
/* Members defined in size */
	const char* accessor;
} grib_accessor_size;

extern grib_accessor_class* grib_accessor_class_long;

static grib_accessor_class _grib_accessor_class_size = {
    &grib_accessor_class_long,                      /* super                     */
    "size",                      /* name                      */
    sizeof(grib_accessor_size),  /* size                      */
    0,                           /* inited */
