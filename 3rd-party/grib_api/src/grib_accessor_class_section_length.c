...
typedef struct grib_accessor_section_length {
    grib_accessor          att;
...
} grib_accessor_section_length;

extern grib_accessor_class* grib_accessor_class_unsigned;

static grib_accessor_class _grib_accessor_class_section_length = {
    &grib_accessor_class_unsigned,                      /* super                     */
    "section_length",                      /* name                      */
    sizeof(grib_accessor_section_length),  /* size                      */
    0,                           /* inited */
