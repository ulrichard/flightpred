...
typedef struct grib_accessor_offset_values {
    grib_accessor          att;
...
} grib_accessor_offset_values;

extern grib_accessor_class* grib_accessor_class_double;

static grib_accessor_class _grib_accessor_class_offset_values = {
    &grib_accessor_class_double,                      /* super                     */
    "offset_values",                      /* name                      */
    sizeof(grib_accessor_offset_values),  /* size                      */
    0,                           /* inited */
