...
/* Members defined in values */
	...
	int dirty;
/* Members defined in data_constant_field */
	const char*  ni;
	const char*  nj;
	const char*  reference_value;
} grib_accessor_data_constant_field;

extern grib_accessor_class* grib_accessor_class_values;

static grib_accessor_class _grib_accessor_class_data_constant_field = {
    &grib_accessor_class_values,                      /* super                     */
    "data_constant_field",                      /* name                      */
    sizeof(grib_accessor_data_constant_field),  /* size                      */
    0,                           /* inited */
...
grib_accessor_class* grib_accessor_class_data_constant_field = &_grib_accessor_class_data_constant_field;
