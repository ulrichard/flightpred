...
} grib_accessor_codetable_title;

extern grib_accessor_class* grib_accessor_class_gen;

static grib_accessor_class _grib_accessor_class_codetable_title = {
    &grib_accessor_class_gen,                      /* super                     */
    "codetable_title",                      /* name                      */
    sizeof(grib_accessor_codetable_title),  /* size                      */
    0,                           /* inited */
