...
sudo apt-get install postgresql postgresql-contrib postgresql-client postgresql-server-dev-8.3 postgresql-8.3-postgis postgis proj libpqxx-dev libgrib-api-dev
