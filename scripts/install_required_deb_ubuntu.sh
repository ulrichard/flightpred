...
sudo apt-get install postgresql-8.3 postgresql-contrib-8.3 postgresql-client-8.3 postgresql-server-dev-8.3 postgresql-8.3-postgis postgis proj libpqxx-dev libgrib-api-dev
